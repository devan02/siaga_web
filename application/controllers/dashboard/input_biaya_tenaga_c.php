...
class Input_biaya_tenaga_c extends CI_Controller {

	function __construct()
	{
		parent::__construct();
		$this->load->model('departemen_divisi_m','dep_div');
		$this->load->model('input_biaya_tenaga_m','model');
	...
	function index()
	{
		...
		$data = array(
		  'page' => "dashboard/input_biaya_tenaga_v",
		  'induk_menu' => "input_biaya",
		  'menu' => "input_biaya_tk",
		  'title' => "INPUT BIAYA TENAGA KERJA (PEGAWAI)",		
		  'departemen'	=> $this->dep_div->departemen(),  
		  'post_url' => "dashboard/input_biaya_tenaga_c",  
		  'msg'  => $msg,
		  'dt' => $dt,
		  'no_gol' => $no_gol,
		  'gol' => $gol,
