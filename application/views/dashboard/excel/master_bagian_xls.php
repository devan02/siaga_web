...
header("Content-Disposition: attachment; filename=Data_Bagian.xls");
?>
    ...
    <tr>
        <td style="text-align:left;" colspan="5">
            <h3 style="font-family:Arial; font-weight:normal; line-height:1.6;">
                Data Bagian PDAM Tirta Patriot Bekasi
            </h3>
        </td>
    </tr>
</table> 
...
<table align="center" class="grid">
    <thead>
        <tr>
            ...
            <th class="kolom_header" style="vertical-align: middle;">KODE BAGIAN</th>
            <th class="kolom_header" style="vertical-align: middle;">NAMA BAGIAN</th>
    ...
    <tbody>
        ...
        <tr style="cursor:pointer;">
            ...
            <td class="isi_table"><?=$row->KODE;?></td>
