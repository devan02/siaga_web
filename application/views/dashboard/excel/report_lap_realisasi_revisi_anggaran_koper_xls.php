...
<table align="center" class="grid">
    ...
    ?>
        ...
        <?php
            ...
            foreach ($realisasi as $data_detil) {
                ...
                $rkap = $rkap = $data_detil->JUMLAH * $data_detil->HARGA;
    ...
    ?>
        <tr style="<?php echo $color; ?>">
            ...
            <td style="<?php echo $color; ?>" width="100" align="center"><?php echo $jumlah; ?></td>
            <td style="<?php echo $color; ?>" width="100" align="center"><?php echo $satuan; ?></td>
            <td style="<?php echo $color; ?>" style="width:120px;"><?php echo $harga; ?></td>
            <td style="<?php echo $color; ?>" style="width:120px;"><?php echo $rkap; ?></td>
            ...
            <td style="<?php echo $color; ?>" style="width:120px;"><?php echo "Rp ".number_format($real_harga,2,',','.'); ?></td>
            <td style="<?php echo $color; ?>" style="width:120px;"><?php echo $real; ?></td>
            <td style="<?php echo $color; ?>" width="100" align="center"><?php echo $sisa_vol; ?></td>
            <td style="<?php echo $color; ?>" style="width:120px;"><?php echo $sisa_rp; ?></td>
        </tr>
        <?php
            if($no_adendum != null){
        ?>
