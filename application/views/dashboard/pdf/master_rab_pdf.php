        ...
        <table align="center" class="grid">
            ...
            <tbody>
                ...
                <tr style="cursor:pointer;">
                    ...
                    <td><?=$row->TAHUN;?></td>
                    <td style="width:250px;"><?=$row->KEGIATAN;?></td>
                    <td style="width:250px;"><?=$row->PEKERJAAN;?></td>
                </tr>
                <?PHP } ?>
            </tbody>
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle("Data RAB PDAM Tirta Patriot Bekasi");
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('data_rab.pdf');
?>
