...
<table align="center" class="grid">
    ...
    ?>
        ...
        <?php
            ...
            foreach ($row_detil as $data_detil) {
                ...
                $real = $real;
                $vol_real = $vol_real;
                $sts_revisi = $sts_revisi;
                $sts_tambahan = $sts_tambahan;
                $color = "";
                $text_color = "";
    ...
    ?>
        <tr class="<?php echo $color; ?>" style="<?php echo $text_color; ?>">
            ...
            <td class="<?php echo $color; ?>" width="80" align="center"><?php echo $jumlah; ?></td>
            <td class="<?php echo $color; ?>" width="80" align="center"><?php echo $satuan; ?></td>
            <td class="<?php echo $color; ?>" style="width:150px;"><?php echo $harga; ?></td>
            <td class="<?php echo $color; ?>" style="width:150px;"><?php echo $rkap; ?></td>
            ...
            <td class="<?php echo $color; ?>" style="width:150px;"><?php echo "Rp. ".number_format($real_harga,2,',','.'); ?></td>
            <td class="<?php echo $color; ?>" style="width:150px;"><?php echo $real; ?></td>
            <td class="<?php echo $color; ?>" width="100" align="center"><?php echo $sisa_vol; ?></td>
            <td class="<?php echo $color; ?>" style="width:150px;"><?php echo $sisa_rp; ?></td>
        </tr>
        <?php
