...
<table align="center" class="grid">
    ...
    ?>
        <tr style="<?php echo $text_color; ?>">
            <td class="<?php echo $color; ?>" width="120" align="center"><?php echo $kode_anggaran; ?></td>
            <td class="<?php echo $color; ?>" width="170"><?php echo $uraian; ?></td>
            <td class="<?php echo $color; ?>" width="150" align="center"><?php echo $divisi; ?></td>
            <td class="<?php echo $color; ?>" width="100" align="center"><?php echo $jumlah; ?></td>
            <td class="<?php echo $color; ?>" width="100" align="center"><?php echo $satuan; ?></td>
            <td class="<?php echo $color; ?>" style="width:120px;"><?php echo $harga; ?></td>
            <td class="<?php echo $color; ?>" style="width:120px;"><?php echo $rkap; ?></td>
            <td class="<?php echo $color; ?>" width="220"><?php echo $no_bukti; ?></td>
            <td class="<?php echo $color; ?>" width="80" align="center"><?php echo $no_keu; ?></td>
            <td class="<?php echo $color; ?>" width="150" align="center"><?php echo $tanggal; ?></td>
            <td class="<?php echo $color; ?>" width="100" align="center"><?php echo $real_vol; ?></td>
            <td class="<?php echo $color; ?>" style="width:120px;"><?php echo "Rp ".number_format($real_harga,2,',','.'); ?></td>
            <td class="<?php echo $color; ?>" style="width:120px;"><?php echo $real; ?></td>
            <td class="<?php echo $color; ?>" width="100" align="center"><?php echo $sisa_vol; ?></td>
            <td class="<?php echo $color; ?>" style="width:120px;"><?php echo $sisa_rp; ?></td>
        </tr>
        <?php
            if($no_adendum != null){
        ?>
        <tr style="<?php echo $text_color; ?>">
            ...
            <td class="<?php echo $color; ?>" >&nbsp;</td>
            <td class="<?php echo $color; ?>" >&nbsp;</td>
            <td class="<?php echo $color; ?>" ><?php echo $no_adendum; ?></td>
            <td class="<?php echo $color; ?>" >&nbsp;</td>
            <td class="<?php echo $color; ?>" >&nbsp;</td>
            <td class="<?php echo $color; ?>"  align="center"><?php echo $real_vol; ?></td>
            <td class="<?php echo $color; ?>" ><?php echo "Rp. ".number_format($nilai_adendum,2,',','.'); ?></td>
            <td class="<?php echo $color; ?>" >&nbsp;</td>
            <td class="<?php echo $color; ?>" >&nbsp;</td>
            <td class="<?php echo $color; ?>" >&nbsp;</td>
        </tr>
    ...
    ?>
        <tr>
            ...
            <td><b><?php echo "Rp. ".number_format($tot_rkap,2,',','.'); ?></b></td>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
            <td><b><?php echo "Rp. ".number_format($tot_realisasi,2,',','.'); ?></b></td>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
        </tr>
    </tbody>
