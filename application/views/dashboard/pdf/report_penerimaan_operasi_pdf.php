...
<table class="grid">
    <thead>
        <tr>
            ...
            <th rowspan="2">JUMLAH<br/>DALAM<br/>REKENING</th>
            <th colspan="12">Bulan</th>
            <th rowspan="2">JUMLAH TAK<br/>TERTAGIH</th>
            <th rowspan="2">JUMLAH<br/>TERTAGIH</th>
            <th rowspan="2">TAHUN<br/>2014</th>
    ...
    <tbody>
        <tr>
            <td><b>I</b></td>
            <td colspan="19"><b>TAGIHAN REKENING AIR</b></td>
        </tr>
        <tr>
            <td align="right">1</td>
            <td><b>Kelompok Pelanggan I</b></td>
        </tr>
        <tr>
            <td align="right">&nbsp;</td>
            <td>Rekening Air Bulan</td>
        </tr>
    <?php
        foreach ($data as $key => $value_kp1) {
    ?>
        <tr>
            <td>&nbsp;</td>
            <td></td>
            <td><?php echo $value_kp1->JANUARI; ?></td>
        </tr>
    <?php
        }
    ?>
