        ...
        <table align="center" class="grid">
            ...
            <tbody>
                ...
                if ($judul1 != $next_judul1 && $row->INDUK == "KERUGIAN LUAR BIASA") {
                    ...
                    echo "<tr>";
                    echo "<td class='judul'><b></b></td>" ;
                    echo "<td text-align='right'><b>Jumlah Biaya di Luar Usaha</b></td>" ;
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle("Rencana Biaya Diluar Usaha $thn");
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('rencana_biaya_luar_usaha.pdf');
?>
