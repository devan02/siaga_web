        ...
        <table class="grid" align="center">
            ...
            <tbody>
                ...
                if ($judul1 != $next_judul1 && $row->INDUK == "BIAYA PEMELIHARAAN SUMBER AIR") {
                    ...
                    echo "<tr>";
                    echo "<td class='judul'><b></b></td>" ;
                    echo "<td text-align='right'><b>Jumlah Biaya Sumber Air</b></td>" ;
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJAN_biaya_sa + $totJAN_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totFEB_biaya_sa + $totFEB_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totMAR_biaya_sa + $totMAR_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totAPR_biaya_sa + $totAPR_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totMEI_biaya_sa + $totMEI_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJUN_biaya_sa + $totJUN_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJUL_biaya_sa + $totJUL_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totAGU_biaya_sa + $totAGU_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totSEP_biaya_sa + $totSEP_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totOKT_biaya_sa + $totOKT_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totNOP_biaya_sa + $totNOP_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totDES_biaya_sa + $totDES_biaya_psa))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJML_biaya_sa + $totJML_biaya_psa))."</b></td>";   

                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJML_LALU1_biaya_sa + $totJML_LALU1_biaya_psa))."</b></td>";                                
                    echo "<td text-align='right'><b>".format_akuntansi(str_replace(',', '.', number_format( ($totJML_LALU1_biaya_trans_dis + $totJML_LALU1_biaya_pe_trans_dis) - ($totJML_biaya_sa + $totJML_biaya_psa) )))."</b></td>";                               
                ...
                if ($judul1 != $next_judul1 && $row->INDUK == "BIAYA PEMELIHARAAN PENGOLAHAN AIR") {
                    ...
                    echo "<tr>";
                    echo "<td class='judul'><b></b></td>" ;
                    echo "<td text-align='right'><b>Jumlah Biaya Pengolahan Air</b></td>" ;
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJAN_biaya_olah_air + $totJAN_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totFEB_biaya_olah_air + $totFEB_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totMAR_biaya_olah_air + $totMAR_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totAPR_biaya_olah_air + $totAPR_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totMEI_biaya_olah_air + $totMEI_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJUN_biaya_olah_air + $totJUN_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJUL_biaya_olah_air + $totJUL_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totAGU_biaya_olah_air + $totAGU_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totSEP_biaya_olah_air + $totSEP_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totOKT_biaya_olah_air + $totOKT_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totNOP_biaya_olah_air + $totNOP_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totDES_biaya_olah_air + $totDES_biaya_pe_olah_air))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJML_biaya_olah_air + $totJML_biaya_pe_olah_air))."</b></td>"; 

                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJML_LALU1_biaya_olah_air + $totJML_LALU1_biaya_pe_olah_air))."</b></td>";                                
                    echo "<td text-align='right'><b>".format_akuntansi(str_replace(',', '.', number_format( ($totJML_LALU1_biaya_olah_air + $totJML_LALU1_biaya_pe_olah_air) - ($totJML_biaya_olah_air + $totJML_biaya_pe_olah_air) )))."</b></td>";                               
                    echo "<td text-align='center'><b>".format_akuntansi(str_replace(',', '.', number_format($persen4)))."</b></td>";                
                    echo "</tr>";
                ...
                if ($judul1 != $next_judul1 && $row->INDUK == "BIAYA PEMELIHARAAN TRANS & DIST") {
                    ...
                    echo "<tr>";
                    echo "<td class='judul'><b></b></td>" ;
                    echo "<td text-align='right'><b>Jumlah Biaya Transmisi dan Distribusi</b></td>" ;
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJAN_biaya_trans_dis + $totJAN_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totFEB_biaya_trans_dis + $totFEB_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totMAR_biaya_trans_dis + $totMAR_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totAPR_biaya_trans_dis + $totAPR_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totMEI_biaya_trans_dis + $totMEI_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJUN_biaya_trans_dis + $totJUN_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJUL_biaya_trans_dis + $totJUL_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totAGU_biaya_trans_dis + $totAGU_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totSEP_biaya_trans_dis + $totSEP_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totOKT_biaya_trans_dis + $totOKT_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totNOP_biaya_trans_dis + $totNOP_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totDES_biaya_trans_dis + $totDES_biaya_pe_trans_dis))."</b></td>";
                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJML_biaya_trans_dis + $totJML_biaya_pe_trans_dis))."</b></td>"; 

                    echo "<td text-align='right'><b>".str_replace(',', '.', number_format($totJML_LALU1_biaya_trans_dis + $totJML_LALU1_biaya_pe_trans_dis))."</b></td>";                                
                    echo "<td text-align='right'><b>".format_akuntansi(str_replace(',', '.', number_format( ($totJML_LALU1_biaya_trans_dis + $totJML_LALU1_biaya_pe_trans_dis) - ($totJML_biaya_trans_dis + $totJML_biaya_pe_trans_dis) )))."</b></td>";                               
                    echo "<td text-align='center'><b>".format_akuntansi(str_replace(',', '.', number_format($persen5)))."</b></td>"; 
                    echo "</tr>";
                ...
                if ($judul1 != $next_judul1 && $row->INDUK == "BIAYA AIR LIMBAH") {
                    ...
                    echo "<tr>";
                    echo "<td class='judul'><b></b></td>" ;
                    echo "<td text-align='left'><b>Jumlah Biaya Operasi</b></td>" ;
                    ...
                    echo "<td text-align='center'><b>".format_akuntansi(str_replace(',', '.', number_format($persen_total)))."</b></td>";                
                    echo "</tr>";                
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle("Rencana Biaya Operasi $thn");
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('rencana_biaya_operasi.pdf');
?>
