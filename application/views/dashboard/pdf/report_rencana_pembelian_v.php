  ...
  border-width  : thin;   
        ...
        <table align="center" class="grid">
            ...
            <tbody>
                ...
                $totDES = 0; $totDES2 = 0;
                $totJML = 0; $totJML2 = 0;
                $totJML_LALU1 = 0; $totJML2_LALU1 = 0;
                ...
                if($nama_perk == "PERSEDIAAN BAHAN OPERASI KIMIA"){
                    $nama_perk = "Pembelian Bahan Operasi Kimia";
                } else if($nama_perk == "PERSEDIAAN BAHAN OPERASI LAINNYA"){
                    $nama_perk = "Pembelian Bahan Operasi Lainnya";
                } else if($nama_perk == "PERSEDIAAN LAIN - LAIN (Stok Minimal)"){
                    $nama_perk = "Pembelian Bahan Lain-lain";
                } else if($nama_perk == "BAHAN INSTALASI"){
                    $nama_perk = "Pembelian Bahan Instalasi";
                }
                ...
                if ($judul1 != $next_judul1 && $row->INDUK == "BAHAN INSTALASI") {
                    ...
                    echo "<tr>";
                    echo "<td class='judul'><b></b></td>" ;
                    echo "<td text-align='center'><b>Jumlah Pembelian</b></td>" ;
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle("Rencana Pembelian Tahun $thn");
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('rencana_pembelian.pdf');
?>
