...
<table align="center">
    <tr>
        ...
        <td><img src="<?=base_url();?>files/pdam/kosong.png" width="340" height="90" alt="KOP PDAM"></td>
        <td>
...
<table align="center" class="grid">
    ...
    <tbody>
        ...
        foreach ($koper as $key => $row) {
            ...
            echo "<tr>";
            echo "<td colspan='11' style='padding-left:10px;'></td>" ;
            echo "</tr>";
            ...
            if ($old_judul != $judul1) {
                $old_judul  = $judul1 ;
                echo "<tr>";
                echo "<td colspan='11' style='padding-left:7px;'><b>".$row->INDUK_KODE." - ".$row->NAMA_PERKIRAAN2."</b></td>" ;
                echo "</tr>";
            }

        ?>
        <tr>
            <td colspan="11" style="padding-left:15px;"><b><?php echo $row->KODE_PERKIRAAN." - ".$row->NAMA_PERKIRAAN; ?></b></td>
        </tr>
        <?php 
        ...
        <tr>
            ...
            <td <?php echo $warna; ?> width="120"><?php echo "Rp. ".number_format($harga_satuan,2,',','.'); ?></td>
            <td <?php echo $warna; ?> width="120"><?php echo "Rp. ".number_format($rkap_fix, 2, ",", "."); ?></td>
            <td <?php echo $warna; ?> width="120"><?php echo "Rp. ".number_format($revisi_fix, 2, ",", "."); ?></td>
        ...
        <tr>
            <td colspan='11' style='padding-left:10px;'></td>
        </tr>
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle("Laporan Revisi RKAP Tahun $thn");
    $html2pdf->WriteHTML($content, isset($_GET['vuehtml']));
    $html2pdf->Output('laporan_revisi_rkap_$thn.pdf');
?>
