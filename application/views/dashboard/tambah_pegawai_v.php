        ...
        <form class="form-horizontal" role="form" method="post" action="<?=base_url().$post_url;?>" enctype="multipart/form-data">
            ...
            <div class="lalalala form-group">
                ...
                <div class="col-lg-3">
                    ...
                    <a href="javascript:;" onclick ="javascript:document.getElementById('imagefile').click();" class="btn btn-dark btn-gradient dark upload-prf" style="width: 80%; margin-top: 10px;">Pilih Foto</a>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <input type="text" required name="nip" id="nip" class="form-control" value="" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input type="text" required name="nama_pegawai" id="nama_pegawai" class="form-control" value="" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2">
                    <input type="text" required name="kode_pos" id="kode_pos" class="form-control" value="" />
                </div>

                <label for="telpon" class="col-lg-1 control-label" style="text-align:right;">Telepon</label>
                <div class="col-lg-2">
                    <input type="text" required name="telpon" id="telpon" class="form-control" value="" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input type="text" required name="tmp_lahir" id="tmp_lahir" class="form-control" value="" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input type="text" required name="jabatan" id="jabatan" class="form-control" value="" />
                </div>
            </div>
