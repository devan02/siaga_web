...
class Input_biaya_tenaga_tkk_m extends CI_Model
{
    ...
    function get_data_tenaga_kerja($no_gol, $tahun, $periode){
        ...
        $sql = "
            ...
            LEFT JOIN(
                ...
                FROM $tbl
            ) b ON a.ID = b.ID_GOL AND b.TAHUN = $tahun AND b.STS_B = 'TKK'
            WHERE a.NO = '$no_gol' AND a.STS = 'TKK'
            ORDER BY a.ID 
        ";
    ...
    function delete_biaya_tenaga_kerja($no_gol, $tahun, $periode){
        ...
        $sql = "
            DELETE FROM $tbl WHERE NO_GOL = '$no_gol' AND TAHUN = $tahun AND STS = 'TKK'
        ";
    ...
    function simpan_biaya_tenaga_kerja($periode, $id_judul, $tahun, $no_gol, $JML,  $JAN, $FEB, $MAR, $APR, $MEI, $JUN, $JUL, $AGU, $SEP, $OKT, $NOP, $DES){
        ...
        VALUES 
        ($id_judul, $tahun, '$no_gol', $JML,  $JAN, $FEB, $MAR, $APR, $MEI, $JUN, $JUL, $AGU, $SEP, $OKT, $NOP, $DES, 'TKK')
        ";
