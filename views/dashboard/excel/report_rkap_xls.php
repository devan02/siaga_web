...
header("Content-Disposition: attachment; filename=Laporan-RKAP.xls");
?>
  ...
  border-width  : thin;   
        ...
        <thead>
            <tr>
                ...
                <th class="kolom_header">Vol Usulan</th>
                <th class="kolom_header">Vol Setuju</th>
        ...
        <tbody>
            ...
            foreach ($koper as $key => $row) {
                    ...
                    echo "<tr>";
                    echo "<td class='isi_table' colspan='10' style='padding-left:10px;'></td>" ;
                    echo "</tr>";
                    ...
                    if ($old_judul != $judul1) {
                        $old_judul  = $judul1 ;
                        echo "<tr>";
                        echo "<td class='isi_table' colspan='10' style='padding-left:7px;'><b>".$row->INDUK_KODE." - ".$row->NAMA_PERKIRAAN2."</b></td>" ;
                        echo "</tr>";
                    }

            ?>
            <tr>
                <td class="isi_table" colspan="10" style="padding-left:15px;"><?php echo $row->KODE_PERKIRAAN." - ".$row->NAMA_PERKIRAAN; ?></td>
            </tr>
            <?php 
