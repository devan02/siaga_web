...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal" role="form" method="post" target="_blank" action="<?=base_url().$post_url;?>">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8" style="margin-top: 8px;">
                    <div class="radio-custom radio-primary mb5">
                        <input type="radio" id="radioExample1" name="jenis_lap" checked="" value="">
                        <label for="radioExample1" style="margin-right: 15px; padding-left: 25px;">Per Rinci Uraian</label>

                        <input type="radio" id="radioExample2" name="jenis_lap" value="koper">
                        <label for="radioExample2" style="margin-right: 15px; padding-left: 25px;">Kode Perkiraan</label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8" style="margin-top: 8px;">
                    <div class="radio-custom radio-primary mb5">
                        <input type="radio" id="radioExample11" name="kriteria" value="">
                        <label for="radioExample11" style="margin-right: 15px; padding-left: 25px;">Semua Bagian</label>

                        <input type="radio" id="radioExample22" name="kriteria" value="dep">
                        <label for="radioExample22" style="margin-right: 15px; padding-left: 25px;">Bagian</label>

                        <input type="radio" id="radioExample33" name="kriteria" value="div" checked="checked">
                        <label for="radioExample33" style="margin-right: 15px; padding-left: 25px;">Sub Bagian</label>
                    </div>
                </div>
            </div>
    ...
    <div class="panel-footer">
        <center>
            ...
            <input value="Cetak Excel" name="excel" type="submit" class="btn btn-default btn-gradient dark" style="margin-top:5px; background-image: url('<?=base_url()?>/ico/xls.gif');background-position: 5px 50%;background-repeat: no-repeat;padding: 4px 4px 4px 22px;" />
             
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
            
            <input name="pdf_jadwal" type="submit" value="Cetak Terjadwal" class="btn btn-default btn-gradient dark" style="margin-top:5px; background-image: url('<?=base_url()?>/ico/pdf.gif');background-position: 5px 50%;background-repeat: no-repeat;padding: 4px 4px 4px 22px;" />

            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 

            <input value="Cetak Terjadwal" name="excel_jadwal" type="submit" class="btn btn-default btn-gradient dark" style="margin-top:5px; background-image: url('<?=base_url()?>/ico/xls.gif');background-position: 5px 50%;background-repeat: no-repeat;padding: 4px 4px 4px 22px;" />
