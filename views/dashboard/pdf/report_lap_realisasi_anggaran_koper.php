...
<table align="center">
    <tr>
        ...
        <td><img src="<?=base_url();?>files/pdam/kosong.png" width="640" height="90" alt="KOP PDAM"></td>
        <td>
...
<table align="center" class="grid">
    <thead>
        <tr>
            ...
            <th width="100" style="text-align:center;"> VOL </th>
            ...
            <th width="150" style="text-align:center;"> NO BUKTI </th>
    ...
    ?>
        <tr>
            ...
            <td <?php echo $color; ?> width="100" align="center"><?php echo $tanggal; ?></td>
        ...
        <tr>
            ...
            <td <?php echo $color; ?> >&nbsp;</td>
            <td <?php echo $color; ?> >&nbsp;</td>
            <td <?php echo $color; ?>  align="center"><?php echo $real_vol; ?></td>
